(function () {
    ...
    commonService.$inject = ['$http', '$q', '$uibModal', 'common'];

    function commonService($http, $q, $uibModal, common) {
        ...
        function mantenerSesion() {
            ajaxPostRequets('/contrato/alive', Math.floor((Math.random() * 100) + 1)).then(function (data) {
            });
        }
